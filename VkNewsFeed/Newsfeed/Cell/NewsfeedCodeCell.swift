...
final class NewsfeedCodeCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        overlayThirdLayerOnTopView() // Третий слой, на top view
        overlayThirdLayerOnBottomView() // Третий слой, на bottom view
        overlayFourthLayerOnBottomViewViews() // Четвертый слой, на bottom view views
    ...
    private func helpInFourthLayer(view: UIView, imageView: UIImageView, label: UILabel) {
        ...
        imageView.heightAnchor.constraint(equalToConstant: Constants.bottomViewViewsItemSize).isActive = true
        imageView.widthAnchor.constraint(equalToConstant: Constants.bottomViewViewsItemSize).isActive = true
